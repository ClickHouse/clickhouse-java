...
public class ClickHouseShortValueTest extends BaseClickHouseValueTest {
    ...
    public void testValue() throws UnknownHostException {
        ...
        checkValue(ClickHouseShortValue.of(0), false, // isInfinity
                ...
                new Object[] { Short.valueOf((short) 0) }, // Array
                new Short[] { Short.valueOf((short) 0) }, // typed Array
                buildMap(new Object[] { 1 }, new Object[] { Short.valueOf((short) 0) }), // Map
                buildMap(new Object[] { 1 }, new Short[] { Short.valueOf((short) 0) }), // typed Map
                Arrays.asList(Short.valueOf((short) 0)) // Tuple
        );
        checkValue(ClickHouseShortValue.of(1), false, // isInfinity
                ...
                Object.class, // Key class
                Short.class, // Value class
                new Object[] { Short.valueOf((short) 1) }, // Array
                new Short[] { Short.valueOf((short) 1) }, // typed Array
                buildMap(new Object[] { 1 }, new Object[] { Short.valueOf((short) 1) }), // Map
                buildMap(new Object[] { 1 }, new Short[] { Short.valueOf((short) 1) }), // typed Map
                Arrays.asList(Short.valueOf((short) 1)) // Tuple
        );
        checkValue(ClickHouseShortValue.of(2), false, // isInfinity
                ...
                Object.class, // Key class
                Short.class, // Value class
                new Object[] { Short.valueOf((short) 2) }, // Array
                new Short[] { Short.valueOf((short) 2) }, // typed Array
                buildMap(new Object[] { 1 }, new Object[] { Short.valueOf((short) 2) }), // Map
                buildMap(new Object[] { 1 }, new Short[] { Short.valueOf((short) 2) }), // typed Map
                Arrays.asList(Short.valueOf((short) 2)) // Tuple
        );
