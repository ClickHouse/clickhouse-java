 ...
 * comparison.
 */
public final class ClickHouseVersionUtils implements Comparable<ClickHouseVersionUtils>, Serializable {
    private static final long serialVersionUID = 6721014333437055314L;

    private static final String STR_LATEST = "latest";

    private static final ClickHouseVersionUtils defaultVersion = new ClickHouseVersionUtils(false, 0, 0, 0, 0);
    private static final ClickHouseVersionUtils latestVersion = new ClickHouseVersionUtils(true, 0, 0, 0, 0);

    private static final ClickHouseCache<String, ClickHouseVersionUtils> versionCache = ClickHouseCache.create(100, 300,
            ClickHouseVersionUtils::parseVersion);
    ...
    public static boolean check(String version, String range) {
        return ClickHouseVersionUtils.of(version).check(range);
    }
    ...
    public static int compare(String fromVersion, String toVersion) {
        return ClickHouseVersionUtils.of(fromVersion).compareTo(ClickHouseVersionUtils.of(toVersion));
    }
     ...
     */
    public static ClickHouseVersionUtils of(String version) {
     ...
     * @return version
     */
    public static ClickHouseVersionUtils of(int yearOrMajor, int... more) {
        int len = more != null ? more.length : 0;
        return new ClickHouseVersionUtils(false, yearOrMajor, len > 0 ? more[0] : 0,
     ...
     * @return parsed version
     */
    protected static ClickHouseVersionUtils parseVersion(String version) {
        if (version == null || version.isEmpty()) {
            return defaultVersion;
        }
        ...
        return latest ? latestVersion : new ClickHouseVersionUtils(false, parts[0], parts[1], parts[2], parts[3]);
    }
    ...
    protected ClickHouseVersionUtils(boolean latest, int year, int feature, int maintenance, int build) {
        this.latest = latest;
     ...
     */
    protected int compareTo(ClickHouseVersionUtils o, boolean sameSeriesComparison) {
        if (o == null) {
            o = defaultVersion;
        }
     ...
     */
    public boolean belongsTo(ClickHouseVersionUtils version) {
        if (version == null) {
    ...
    public boolean belongsTo(String version) {
        return belongsTo(ClickHouseVersionUtils.of(version));
    }
     ...
     * when comparing "21.3.1.1" to "21.3", {@link #compareTo(ClickHouseVersionUtils)}
     ...
     *         otherwise
     */
    public boolean isNewerOrEqualTo(ClickHouseVersionUtils version) {
    ...
    public boolean isNewerOrEqualTo(String version) {
        return isNewerOrEqualTo(ClickHouseVersionUtils.of(version));
    }
     ...
     */
    public boolean isNewerThan(ClickHouseVersionUtils version) {
    ...
    public boolean isNewerThan(String version) {
        return isNewerThan(ClickHouseVersionUtils.of(version));
    }
     ...
     *         otherwise
     */
    public boolean isOlderOrEqualTo(ClickHouseVersionUtils version) {
        return compareTo(version, true) <= 0;
    }
    ...
    public boolean isOlderOrEqualTo(String version) {
        return isOlderOrEqualTo(ClickHouseVersionUtils.of(version));
    }
     ...
     */
    public boolean isOlderThan(ClickHouseVersionUtils version) {
        return compareTo(version, false) < 0;
    }
    ...
    public boolean isOlderThan(String version) {
        return isOlderThan(ClickHouseVersionUtils.of(version));
    }
    ...
    public boolean check(String range) {
        ...
        for (int i = 0, len = range.length(); i < len; i++) {
            ...
            if ((ch >= '0' && ch <= '9') || ch == '.') {
                ...
                ClickHouseVersionUtils v1 = null;
                ClickHouseVersionUtils v2 = null;
                ...
                for (i = i + 1; i < len; i++) {
                    ...
                    if ((nextCh >= '0' && nextCh <= '9') || nextCh == '.') {
                        ...
                        v1 = ClickHouseVersionUtils.of(builder.toString());
                        builder.setLength(0);
                    } else if (nextCh == ')' || nextCh == ']') {
                        if (builder.length() == 0) {
                            v2 = latestVersion;
                        } else {
                            v2 = ClickHouseVersionUtils.of(builder.toString());
                            builder.setLength(0);
                        }
                        break;
                    }
                ...
                ClickHouseVersionUtils v = of(builder.toString());
                builder.setLength(0);
    ...
    @Override
    public int compareTo(ClickHouseVersionUtils o) {
    ...
    public boolean equals(Object obj) {
        ...
        ClickHouseVersionUtils other = (ClickHouseVersionUtils) obj;
