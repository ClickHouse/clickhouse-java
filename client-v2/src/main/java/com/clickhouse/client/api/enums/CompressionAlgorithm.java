 ...
 *     <li>{@link #ZSTD} - needs {@code com.github.luben:zstd-jni} on the classpath. The dependency is
 *     {@code provided}, so an application that selects this algorithm has to declare it.</li>
