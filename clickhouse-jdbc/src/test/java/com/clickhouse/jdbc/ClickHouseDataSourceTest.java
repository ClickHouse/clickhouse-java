    ...
    public void testGetConnection() throws SQLException {
        ...
        for (ClickHouseDataSource ds : new ClickHouseDataSource[] {
            ...
            for (ClickHouseConnection connection : new ClickHouseConnection[] {
                    ...
                    (ClickHouseConnection) new ClickHouseDriver().connect(url, properties),
                    (ClickHouseConnection) new ClickHouseDriver().connect(urlWithCredentials, properties),
                    (ClickHouseConnection) new ClickHouseDriver().connect(url + params, new Properties()),
                    (ClickHouseConnection) new ClickHouseDriver().connect(urlWithCredentials + params, new Properties()),
