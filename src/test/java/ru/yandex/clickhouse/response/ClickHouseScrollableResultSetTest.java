...
public class ClickHouseScrollableResultSetTest {
    ...
    public void toLongArrayTest(String str, long[] expected) throws Exception {
        Assert.assertEquals(
                ClickHouseScrollableResultSet.toLongArray(ByteFragment.fromString(str)),
                expected
        );
    }
    ...
    public void withoutTotals() throws Exception {
        ...
        ResultSet rs = new ClickHouseScrollableResultSet(is, 1024, "db", "table", false, null, null, props);
    ...
    public void withoutTotalsSingleColumn() throws Exception {
        ...
        ClickHouseScrollableResultSet rs = new ClickHouseScrollableResultSet(is, 1024, "db", "table", false, null, null, props);
    ...
    public void withTotals() throws Exception {
        ...
        ClickHouseScrollableResultSet rs = new ClickHouseScrollableResultSet(is, 1024, "db", "table", true, null, null, props);
    ...
    public void withTotalsSingleColumn() throws Exception {
        ...
        ResultSet rs = new ClickHouseScrollableResultSet(is, 1024, "db", "table", true, null, null, props);
