// based on https://github.com/ClickHouse/ClickHouse/blob/master/src/Parsers/New/ClickHouseParser.g4
...
dictionaryAttrDfnt
locals [java.util.Set<String> attrs = new java.util.HashSet<>()]:
...
locals [java.util.Set<String> clauses = new java.util.HashSet<>()]:
