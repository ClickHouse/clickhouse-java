...
/**
 * Proxy wrapper for java.sql.ResultSet.
 * <p>
 * This proxy delegates all calls to the underlying ResultSet from a specific
 * driver version. Unlike Connection and Statement proxies, ResultSet proxy
 * does not support failover since results are inherently tied to a specific
 * execution context.
 */
public class ResultSetProxy implements ResultSet {
    ...
    /**
     * Creates a new ResultSetProxy.
     *
     * @param delegate       the underlying ResultSet to delegate to
     * @param driverVersion  the driver version that created this ResultSet
     * @param statementProxy the parent statement proxy (may be null)
     */
    public ResultSetProxy(ResultSet delegate, DriverVersion driverVersion, StatementProxy statementProxy) {
    ...
    /**
     * Returns the driver version that created this ResultSet.
     *
    ...
    public Statement getStatement() throws SQLException {
        return statementProxy != null ? statementProxy : delegate.getStatement();
    }
